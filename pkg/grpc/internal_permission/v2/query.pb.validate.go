...
func (m *ResourceFilter) validate(all bool) error {
	...
	case *ResourceFilter_ProjectId:
		...
		oneofResourcePresent = true
		// no validation rules for ProjectId
	case *ResourceFilter_ProjectGrant_:
		if v == nil {
			err := ResourceFilterValidationError{
				field:  "Resource",
				reason: "oneof value cannot be a typed-nil",
...
// Validate checks the field values on ResourceFilter_ProjectGrant with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ResourceFilter_ProjectGrant) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ResourceFilter_ProjectGrant with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ResourceFilter_ProjectGrantMultiError, or nil if none found.
func (m *ResourceFilter_ProjectGrant) ValidateAll() error {
	return m.validate(true)
}

func (m *ResourceFilter_ProjectGrant) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if l := utf8.RuneCountInString(m.GetProjectId()); l < 1 || l > 200 {
		err := ResourceFilter_ProjectGrantValidationError{
			field:  "ProjectId",
			reason: "value length must be between 1 and 200 runes, inclusive",
		}
		if !all {
	...
	if len(errors) > 0 {
		return ResourceFilter_ProjectGrantMultiError(errors)
	}

	return nil
}

// ResourceFilter_ProjectGrantMultiError is an error wrapping multiple
// validation errors returned by ResourceFilter_ProjectGrant.ValidateAll() if
// the designated constraints aren't met.
type ResourceFilter_ProjectGrantMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ResourceFilter_ProjectGrantMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ResourceFilter_ProjectGrantMultiError) AllErrors() []error { return m }

// ResourceFilter_ProjectGrantValidationError is the validation error returned
// by ResourceFilter_ProjectGrant.Validate if the designated constraints
// aren't met.
type ResourceFilter_ProjectGrantValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ResourceFilter_ProjectGrantValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ResourceFilter_ProjectGrantValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ResourceFilter_ProjectGrantValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ResourceFilter_ProjectGrantValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ResourceFilter_ProjectGrantValidationError) ErrorName() string {
	return "ResourceFilter_ProjectGrantValidationError"
}

// Error satisfies the builtin error interface
func (e ResourceFilter_ProjectGrantValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sResourceFilter_ProjectGrant.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ResourceFilter_ProjectGrantValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ResourceFilter_ProjectGrantValidationError{}
