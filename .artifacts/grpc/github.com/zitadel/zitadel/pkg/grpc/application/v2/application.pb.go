...
const file_zitadel_application_v2_application_proto_rawDesc = "" +
	...
	"typeFilterB\r\n" +
	"\x06filter\x12\x03\xf8B\x01\"W\n" +
	"\x0fProjectIDFilter\x12D\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tB%\x92A\x15J\x13\"69629023906488334\"\xe0A\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tprojectId\"\x88\x01\n" +
	...
	"!ApplicationKeyApplicationIDFilter\x12J\n" +
	"\x0eapplication_id\x18\x01 \x01(\tB#\x92A\x15J\x13\"69629023906488334\"\xe0A\x02\xfaB\x05r\x03\x18\xc8\x01R\rapplicationId\"e\n" +
	"\x1dApplicationKeyProjectIDFilter\x12D\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tB%\x92A\x15J\x13\"69629023906488334\"\xe0A\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tprojectId\"t\n" +
	"\"ApplicationKeyOrganizationIDFilter\x12N\n" +
	"\x0forganization_id\x18\x01 \x01(\tB%\x92A\x15J\x13\"69629023906488334\"\xe0A\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x0eorganizationId\"\xde\x02\n" +
