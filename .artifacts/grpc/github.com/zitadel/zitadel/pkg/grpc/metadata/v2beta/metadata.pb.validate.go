...
// Validate checks the field values on MetadataKeyQuery with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *MetadataKeyQuery) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MetadataKeyQuery with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MetadataKeyQueryMultiError, or nil if none found.
func (m *MetadataKeyQuery) ValidateAll() error {
	return m.validate(true)
}

func (m *MetadataKeyQuery) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetKey()) > 200 {
		err := MetadataKeyQueryValidationError{
			field:  "Key",
	...
	if len(errors) > 0 {
		return MetadataKeyQueryMultiError(errors)
	}

	return nil
}

// MetadataKeyQueryMultiError is an error wrapping multiple validation errors
// returned by MetadataKeyQuery.ValidateAll() if the designated constraints
// aren't met.
type MetadataKeyQueryMultiError []error
...
// AllErrors returns a list of validation violation errors.
func (m MetadataKeyQueryMultiError) AllErrors() []error { return m }

// MetadataKeyQueryValidationError is the validation error returned by
// MetadataKeyQuery.Validate if the designated constraints aren't met.
type MetadataKeyQueryValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MetadataKeyQueryValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MetadataKeyQueryValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MetadataKeyQueryValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MetadataKeyQueryValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MetadataKeyQueryValidationError) ErrorName() string { return "MetadataKeyQueryValidationError" }

// Error satisfies the builtin error interface
func (e MetadataKeyQueryValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMetadataKeyQuery.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MetadataKeyQueryValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MetadataKeyQueryValidationError{}
