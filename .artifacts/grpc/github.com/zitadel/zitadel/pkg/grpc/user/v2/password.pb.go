...
const file_zitadel_user_v2_password_proto_rawDesc = "" +
	"\n" +
	"\x1ezitadel/user/v2/password.proto\x12\x0fzitadel.user.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"z\n" +
	"\bPassword\x12E\n" +
	...
	"\r_url_template\"\x19\n" +
	"\x17ReturnPasswordResetCode\"\x9e\x03\n" +
	"\vSetPassword\x127\n" +
	"\bpassword\x18\x01 \x01(\v2\x19.zitadel.user.v2.PasswordH\x00R\bpassword\x12J\n" +
	"\x0fhashed_password\x18\x02 \x01(\v2\x1f.zitadel.user.v2.HashedPasswordH\x00R\x0ehashedPassword\x12V\n" +
